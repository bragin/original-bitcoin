...
CMainFrameBase::CMainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_menuView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( CMainFrameBase::OnMenuViewShowGenerated ), this, m_menuViewShowGenerated->GetId());
...
CMainFrameBase::~CMainFrameBase()
{
	...
	this->Disconnect( wxID_VIEWSHOWGENERATED, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( CMainFrameBase::OnUpdateUIViewShowGenerated ) );
...
CViewProductDialogBase::CViewProductDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_richTextHeading = new wxRichTextCtrl( m_scrolledWindow, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1,50 ), wxTE_READONLY|wxBORDER_NONE );
...
CPokerDialogBase::CPokerDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	this->Connect( wxEVT_AUX1_DOWN, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Connect( wxEVT_AUX2_DOWN, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	...
	this->Connect( wxEVT_AUX1_DCLICK, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Connect( wxEVT_AUX2_DCLICK, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
...
CPokerDialogBase::~CPokerDialogBase()
{
	...
	this->Disconnect( wxEVT_AUX1_DOWN, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Disconnect( wxEVT_AUX1_UP, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Disconnect( wxEVT_AUX2_DOWN, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Disconnect( wxEVT_AUX2_UP, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	...
	this->Disconnect( wxEVT_AUX1_DCLICK, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
	this->Disconnect( wxEVT_AUX2_DCLICK, wxMouseEventHandler( CPokerDialogBase::OnMouseEvents ) );
